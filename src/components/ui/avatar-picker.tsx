...
interface AvatarPickerProps {
    username?: string;
    onSaveAvatar?: (avatarId: number | null, customImage?: string | null) => void;
}

export function AvatarPicker({ username = "Me", onSaveAvatar }: AvatarPickerProps) {
    ...
    const handleSaveAvatar = () => {
        if (onSaveAvatar) {
            onSaveAvatar(selectedAvatar?.id || null, customImage);
        }
    };
                ...
                <CardContent className="p-0">
                    ...
                    <div className="px-8 pb-8 -mt-16">
                            ...
                            >
                                ...
                                >
                                    <label 
                                        ...
                                        className={cn(
                                            "flex items-center justify-center w-12 h-12 rounded-full border-2 border-dashed cursor-pointer",
                        ...
                        {onSaveAvatar && (
                            ...
                            >
                                <Button onClick={handleSaveAvatar} className="px-8">
                                    Save Avatar
                                </Button>
                            </motion.div>
                        )}
